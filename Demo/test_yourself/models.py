...
class Comment(models.Model):
    question = models.ForeignKey(MCQQuestion,verbose_name='Comment_of_Question',on_delete=models.CASCADE)
    ...
    def __str__(self):
        return '{} Commented on {}'.format(str(self.user.username), self.question)